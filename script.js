...
// 2nd vid is for Slice, Splice (mutate the original array), Reverse (mutate the original array), Concat (make new array and can be done using split (...arr)) and Join method

// ========== The At Method in 3rd vid ============
// const arr = [23, 11, 64];
...
// You cant break out from forEach loop
...
//   const dJCorrected = dJ.slice(1, -2); // [5, 2, 12]
//   const bothC = dJCorrected.concat(dK);

//   bothC.forEach(function (age, i) {
//     if (age >= 3) {
...
// const balance = movements.reduce((acc, curr, i, arr) => acc + curr, 100);
// console.log(balance);
...
// let x = calcAverageHumanAge([5, 2, 4, 1, 15, 8, 3]);
// let y = calcAverageHumanAge([16, 6, 10, 5, 6, 1, 4]);
// console.log(x, y);
...
// Sorting Strings
// const owners = ['Jonas', 'adam', 'mazhar'];
